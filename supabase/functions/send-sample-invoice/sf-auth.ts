// supabase/functions/send-kickoff-email/sf-auth.ts
//
// Salesforce JWT Bearer auth — vendored copy of the helper used by
// send-ops-handoff. Kept local to this function so we don't touch any
// other deployed function while rewriting the kickoff email path.
// When a third SF-touching function lands, fold this into
// supabase/functions/_shared/sf-auth.ts.
...
/** Plain JSON SF REST call. Throws on non-2xx with the response body. */
